...
function extractLatLong(postcodeResponse, res){
    return {
...
postcodeRequest.send();
    ...
    function findNearestStops(location, res){
      ...
      var allBuses = [];
      findSoonest5Buses(busStop1, res, allBuses);
        ...
        findSoonest5Buses = function(busStop1, res, allBuses) {
            var departureBoard = [];
